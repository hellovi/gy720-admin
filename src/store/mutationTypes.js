...
export const EDIT = {
  ...
  MATERIAL: {
    ...
    INVOKES: 'EDIT.MATERIAL.INVOKES',

    SELECT: 'EDIT.MATERIAL.SELECT',
    SELECTS: 'EDIT.MATERIAL.SELECTS',
    RESET: 'EDIT.MATERIAL.RESET',

    SELECT_OBJECT3D: 'EDIT.MATERIAL.SELECT_OBJECT3D',

    SET_SMALLSCREEN: 'EDIT.MATERIAL.SET_SMALLSCREEN',
  },
...
export const SERVICE = {
  MODAL: {
    INIT: 'SERVICE.MODAL.INIT',
    OPEN: 'SERVICE.MODAL.OPEN',
    CLOSE: 'SERVICE.MODAL.CLOSE',
    BUYTYPE: 'SERVICE.MODAL.BUYTYPE',
    CREATEORDER: 'SERVICE.MODAL.CREATEORDER',
    RESET: 'SERVICE.MODAL.RESET',
    SETPANOINFO: 'SERVICE.MODAL.SETPANOINFO',
    RESETPANOINFO: 'SERVICE.MODAL.RESETPANOINFO',
    COMPLETEPAY: 'SERVICE.MODAL.COMPLETEPAY',
    CALLBACK: 'SERVICE.MODAL.CALLBACK',
  },
}
