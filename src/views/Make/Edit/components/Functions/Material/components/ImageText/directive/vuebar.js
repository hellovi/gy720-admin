  ...
  function createState(el) {
    el._vuebarState = {
      ...
      config: {
        ...
        el1Class: 'vuebar',
        el1ScrollVisibleClass: 'vuebar-visible',
        el1ScrollInvisibleClass: 'vuebar-invisible',
        el1ScrollingClass: 'vuebar-scrolling',
        el1ScrollingPhantomClass: 'vuebar-scrolling-phantom',
        el1DraggingClass: 'vuebar-dragging',
        el1DraggingPhantomClass: 'vuebar-dragging-phantom',

        el2Class: 'vuebar-content',

        draggerClass: 'vuebar-dragger',
        draggerStylerClass: 'vuebar-dragger-styler',
      },
