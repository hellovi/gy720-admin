/* eslint-disable */
// vuedraggable依赖sortablejs 1.6，但sortablejs1.5及以上的版本在存在多个draggable组件时有bug
// 为解决这个问题，把vuedraggable代码放置在这里，使它能引用项目里指定的sortablejs版本
...
export default buildDraggable(Sortable);
