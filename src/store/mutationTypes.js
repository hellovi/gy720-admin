...
export const WORKS = {
  CATE: {
    INITIALIZE: 'WORKS.CATELIST.INITIALIZE',
    CREATE: 'WORKS.CATELIST.CREATE',
    DELETE: 'WORKS.CATELIST.DELETE',
  },
  WORKLIST: {
    INITIALIZE: 'WORKS.WORKLIST.INITIALIZE',
    DELETE: 'WORKS.WORKLIST.DELETE',
    UPDATE: 'WORKS.WORKLIST.UPDATE',
  },
  SELECTEDLIST: {
    INITIALIZE: 'WORKS.SELECTEDLIST.INITIALIZE',
    UPDATE: 'WORKS.SELECTEDLIST.UPDATE',
  },
}
